...
ADMIN_IDS = [6385496035, 5152638249] # СПИСОК ID АДМИНИСТРАТОРОВ
...
DEFAULT_SETTINGS = {
    ...
    '_id': 'bot_settings',
    'transfer_limits': {'standart': 5000000, 'assassin': 7000000, 'vip': 10000000, 'pro': 30000000, 'max': 100000000},
...
async def get_user_data(user_id: int):
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        default_user_structure = {
             '_id': user_id, 'balance_normal': 100, 'balance_special': 0, 'balance_galactic': 0, 'balance_bank': 0,
